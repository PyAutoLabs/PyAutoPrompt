...
## convergence-func-xp
- issue: https://github.com/PyAutoLabs/PyAutoGalaxy/issues/456
- completed: 2026-05-27
...
- completed: 2026-05-27
- workspace-pr: https://github.com/PyAutoLabs/autolens_workspace_test/pull/132
- notes: Fast/full test modes for mass profile test suite. Fast (default) <30s, full sweeps parameter extremes. Final item from mass_profiles_followup tracker.
...
## wiki-current-api-only
- issue: https://github.com/PyAutoLabs/autolens_assistant/issues/11
- completed: 2026-05-28
- library-pr: https://github.com/PyAutoLabs/autolens_assistant/pull/12
- repos: autolens_assistant
- notes: Implemented the current-API-only wiki policy from #9/PR#10. Deleted wiki/core/api_deltas_2026_05.md (-150 lines); its current-API facts (mesh regression warning, Tracer limitations + Jacobian magnification workaround, FITS helpers, flat plot-function API) already lived on the topic pages. Dropped the 10 "see api_deltas" pointers across 9 files (repointed to api/plotting.md / lensing_basics.md) and de-migration-ified inline notes in datasets/autoarray/autolens/inversions/lensing_basics/tracer to current-API-only phrasing. Verified: git grep api_deltas empty, --check-version clean, --scope all drift 23->22 (remaining 22 pre-existing). Completes the 3-part Kernel2D/API-drift series (#10 tooling+policy, #12 wiki cleanup). Still queued: pyautobuild_api_baseline_release.md (release-pipeline baseline auto-refresh).
...
## wdm-lya-citations
- issue: https://github.com/PyAutoLabs/PyAutoPaper/issues/9
- completed: 2026-06-22
